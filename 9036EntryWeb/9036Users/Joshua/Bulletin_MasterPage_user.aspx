...
<script runat="server"> 
    ...
    {
        Response.Redirect("~/Joshua/Edit_yoyo_MP_user.aspx");
    }

    
    protected void PersonalManage_Click(object sender, EventArgs e)
    {

        Response.Redirect("~/Joshua/PersonalManage_user.aspx");
    }

    protected void Search_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Joshua/SearchBulletin_MP_user.aspx");
    }
    //paging
    ...
    <div id="form1" runat="server">
        <div>
            ...
            <%--<div style="width: 55%; text-align: center">--%>
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="PersonalManage_Click" class="btn btn-warning">
                管理個人公告<i class="fas fa-wrench"></i>
                </asp:LinkButton>
            <%--</div>--%>
            <br />
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" OnItemDeleting="ListView1_ItemDeleting" OnItemCommand="ListView1_ItemCommand" OnItemUpdating="ListView1_ItemUpdating1" OnItemEditing="ListView1_ItemEditing" OnPagePropertiesChanging="ListView1_PagePropertiesChanging" OnSorting="lvProducts_Sorting">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="HyperLink1" runat="server" ForeColor='<%#(Eval("TopPost").ToString()=="1"?System.Drawing.Color.Red:System.Drawing.ColorTranslator.FromHtml("#284775")) %>' NavigateUrl='<%# Eval("Id", "~/Joshua/ShowTitle_MP_user.aspx?Id={0}") %>'>
