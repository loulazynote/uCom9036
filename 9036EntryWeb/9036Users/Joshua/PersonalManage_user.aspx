...
<script runat="server"> 
    ...
    private void BindListView()
    {
      ...
      ["Entry9036"].ConnectionString);
        ...
        if (announcer != null)
        {
            sqlCondition += " AND Announcer like N'%" + announcer + "%'"; //AND Title like N'%北%'
        }
...
["Entry9036"].ConnectionString);
    ...
    //{
    //    Response.Redirect("~/Bulletin_MasterPage_user.aspx");
    //}
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <a class="fas fa-pen" href='Edit_user.aspx?id=<%#Eval("Id")%>'></a>
