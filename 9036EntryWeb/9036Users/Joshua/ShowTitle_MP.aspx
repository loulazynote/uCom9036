...
<script runat="server">
    ...
    protected void Top_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("UPDATE Bulletin SET [TopPost] = 1 WHERE (id=@Id) ", cn);
    ...
    protected void CancelTop_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("UPDATE Bulletin SET [TopPost] = 0 WHERE (id=@Id) ", cn);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row" id="my-timeline">
        ...
        <div class="col-md-12">
            ...
            <br />
            <asp:FormView ID="FormView1" runat="server" BackColor="#ffffff" BorderColor="cadetblue" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Both">
                <ItemTemplate>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="textStyle">公告主題: </div>
