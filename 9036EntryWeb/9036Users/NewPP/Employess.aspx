...
<script runat="server">
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("SELECT [Id], [EmpId], [Starttime], [Overtime], [Event], [Hour], [Result], [Content], [Replay], [Nowdate], [Department] FROM [AllEmployess] WHERE [EmpId]=N'王小明' ",
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [AllEmployess] WHERE [EmpId]=N'王小明' ",
        ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        ...
        xlsx.Save(Server.MapPath(@"Output\Weng.xlsx"));
        Response.Redirect("~/NewPP/Output/Weng.xlsx");
    }
    ...
    protected void ListView1_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        //Response.Write("aa" + aa.Row.ItemArray[0]);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ItemTemplate>
            <tr style="background-color: #FFFFFF; color: #333333;">
                ...
                <td>
                    ...
                    <asp:HyperLink class="btn btn-success" ID="HyperLink1" NavigateUrl='<%# Eval("Id","EmpEdit.aspx?id={0}") %>' runat="server">修改</asp:HyperLink>
                    <%--<a ID="Edit" href="EmpEdit.aspx?id=<%# Eval("Id") %>">修改</a>--%>
                ...
                <tr runat="server">
                    <td runat="server">
                        <table class="table table-bordered table-hover" id="itemPlaceholderContainer" runat="server">
                            <tr runat="server" style="background-color: rgba(153, 153, 153, 0.72); color: #333333;">
    ...
    <a class="mb-xs mt-xs mr-xs btn btn-lg btn btn-info" href="EmpEdit.aspx?Mode=Insert">申請假單</a>

    <%--href="EmpEdit.aspx?Mode=Insert"    '<%# Eval("AllEmployess", "ShowProduct.aspx?id={0}") %>'--%>

    <asp:Button ID="But1" runat="server" Text="EXCEL 輸出" OnClientClick="alert('EXCEL輸出完成');" CssClass="col-sm-1.5 text-center btn btn-success" OnClick="But1_Click" />
</asp:Content>
