...
<script runat="server">
    ...
    //id判斷進入者
    private void BindFormView(int EmpId)
    {
                ...
                <div class="table">
                        ...
                        <table class="table" style="width: 500px;">
                            ...
                            <tr>
                                <td>員工名稱 ：</td>
                                <td>
                                    <asp:Label ID="Label2" runat="server" Text='林小威' />
<%--                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("EmpId") %>' />--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("Department") %>' />
                                </td>
            ...
            <ItemTemplate>
                假單編號:
                    <asp:Label ID="假單編號" runat="server" Text='<%# Eval("Id") %>' />
                <br />
                員工名稱:
                    <asp:Label ID="員工名稱" runat="server" Text='<%# Bind("EmpId") %>' />
                <br />
                開始時間:
                    <asp:Label ID="開始時間" runat="server" Text='<%# Bind("Starttime") %>' />
                <br />
                結束時間:
                    <asp:Label ID="結束時間" runat="server" Text='<%# Bind("Overtime") %>' />
                <br />
                假單:
                    <asp:Label ID="假單" runat="server" Text='<%# Bind("Event") %>' />
                <br />
                時數:
                    <asp:Label ID="時數" runat="server" Text='<%# Bind("Hour") %>' />
                <br />
                備註原因:
                    <asp:Label ID="備註原因" runat="server" Text='<%# Bind("Content") %>' />
                <br />
                部門:
                    <asp:Label ID="部門" runat="server" Text='<%# Bind("Department") %>' />
                <br />
