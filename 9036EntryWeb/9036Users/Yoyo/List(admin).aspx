...
<script runat="server">
    ...
    protected void ListView1_ItemDeleting(object sender, ListViewDeleteEventArgs e)
    {
        ...
        cn.Close();
        Response.Redirect("~/Yoyo/List(admin).aspx");
    }
</script>
    ...
    <div class="greenBorder" style="display: table; width: 100%; height: 400px; #position: relative; overflow: hidden;">
        <div style="#position: absolute; #top: 50%; display: table-cell; vertical-align: middle;">
            <div class="center1234" style="#position: relative; #top: -50%">
                <iframe width="1500" height="350" style="border: none;" src="Default.aspx"></iframe>
            </div>
                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane active">
                            <asp:ListView ID="ListView3" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" GroupItemCount="1" OnItemDeleting="ListView1_ItemDeleting">
                                ...
                                <ItemTemplate>
                                    <tr style="text-align: center">
                                        ...
                                        <td>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("Commentcount") %>' />
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <LayoutTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Yoyo %>" SelectCommand="SELECT * FROM  (SELECT TOP 7 * FROM Forum ORDER BY Commentcount DESC) as my ORDER BY Commentcount DESC "></asp:SqlDataSource>
                            <div style="float: right">
                                <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="more(Hot).aspx">more...</asp:HyperLink>
                            </div>
                        <br />                           
                        </div>
                        <div id="menu1" class="tab-pane fade">
                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource2" GroupItemCount="1" OnItemDeleting="ListView1_ItemDeleting">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Yoyo %>" SelectCommand="SELECT * FROM  (SELECT TOP 7 * FROM Forum ORDER BY DateTime DESC) as my ORDER BY DateTime DESC "></asp:SqlDataSource>
                            <div style="float: right">
                                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="more(Time).aspx">more...</asp:HyperLink>
                            </div>
                            <br />
                        </div>
                    </div>
