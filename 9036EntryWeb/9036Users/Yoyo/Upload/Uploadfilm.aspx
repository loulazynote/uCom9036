                ...
                using (BinaryReader br = new BinaryReader(fs))
                {
                    ...
                    using (SqlConnection con = new SqlConnection(constr))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@MNT_USER", title);
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Yoyo %>" SelectCommand="SELECT [GUID], [FILE_NAME], [SIZE] FROM [Document] WHERE ([MNT_USER] = @MNT_USER)">
            <SelectParameters>
                <asp:QueryStringParameter Name="MNT_USER" QueryStringField="title" Type="String" />                
            </SelectParameters>
        </asp:SqlDataSource>
