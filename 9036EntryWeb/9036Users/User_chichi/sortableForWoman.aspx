...
<head runat="server">
    ...
    <style>
        body {
            ...
            font-size: 28px;
            line-height: 36px;
            background-image: url("../images/backgroundImage/6.jpg");
        }
...
<body>
    ...
    <script>
        ...
        $(function () {
            var womanId = $("#HiddenField1").val();
            console.log(womanId); //抓取女性Id
            //console.log("123");
            $.ajax({
                type: "POST",
                async: false,
                url: "WebService.asmx/QueryManInfo",
                data: JSON.stringify({
                }),
            ...
            $("#sortable li").addClass("btn-danger");
                ...
                swal({
                    ...
                    function () {
                        ...
                        $.ajax({
                            type: "POST",
                            async: false,
                            url: "WebService.asmx/GetListFromWoman",
                            data: JSON.stringify({
                                Id: womanId,
                                sort: lis_String
                            }),
