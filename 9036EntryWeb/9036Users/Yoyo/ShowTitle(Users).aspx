...
<script runat="server">
    ...
    ConfigurationManager.ConnectionStrings["Yoyo"].ConnectionString);
        ...
        Response.Redirect("~/Yoyo/ShowTitle(Users).aspx?id=" + titleid);
                        ...
                        <table style="width: 500px">
                            <tr style="">
                                <td>
                                    ...
                                    <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" Visible='<%# Convert.ToBoolean( (Session["UID"].ToString()).Equals(Eval("UserName"))) %>' />
                                    <br />
